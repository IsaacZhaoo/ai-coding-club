...
## 练习
- 为一个项目写 10 行“推介文案” + 3 个可能的面试问题。

你有技能。你有项目。现在是时候把所有东西整合在一起，准备好作为开发者获得你的第一份工作了。这篇文章涵盖了最后的步骤：构建一个令人信服的作品集并准备面试。

如果你准备的是 AI Agent 工程岗位，可以继续阅读 [AI Agent 求职作品集指南](/zh/docs/tutorials/ai-agent-portfolio-guide/)，把一个项目整理成覆盖架构、任务、Trace、Eval、安全边界和交付能力的可验证证据链。
