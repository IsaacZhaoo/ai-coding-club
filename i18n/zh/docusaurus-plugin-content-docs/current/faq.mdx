...
- 刚接触 AI 编程？[入门教程](/docs/tutorials/getting-started)
...
**下一步：**
- 阅读我们的[入门教程](/docs/tutorials/getting-started)
- 学习[提示工程](/docs/best-practices#-prompt-engineering-best-practices)
...
- 在重复上下文上节省 90%
- 非常适合大型代码库
- [查看我们的缓存指南](/blog/claude-prompt-caching)
...
查看我们的[提示工程指南](/docs/best-practices#-prompt-engineering-best-practices)。
...
3. **安全吗？** → 是的，但不要分享敏感数据
4. **会取代我吗？** → 不，它让你更高效
5. **如何开始？** → 尝试 ChatGPT 免费版，阅读我们的[教程](/docs/tutorials/getting-started)
