...
如果你维护的是 TypeScript client 或 server，可以继续看 [MCP 2026-07-28 无状态迁移指南](/zh/docs/tutorials/mcp-2026-07-28-stateless-migration/)，把 SDK v2 包升级、协议启用、状态搬迁和旧 client 验证分开处理。

如果连接已经跑通，但 Agent 仍会选错操作或不知道怎么从错误中恢复，可以用 [MCP Tool 设计指南](/zh/docs/tutorials/mcp-tool-design-guide/) 检查任务边界、Schema、annotation、返回值和错误路径。
:::
