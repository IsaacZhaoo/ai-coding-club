...
<FAQSchema
  items={[
    {
      question: 'AI Agents 和 Cursor Rules 有什么区别？',
      answer: 'Cursor Rules 定义项目级标准，Agents 定义角色级知识与流程。',
    },
    {
      question: '一个项目可以用多个 Agent 吗？',
      answer: '可以。根据任务切换 Agent，比如前端/后端/测试/运维。',
    },
    {
      question: 'Agents 会自动执行代码吗？',
      answer: '不会。Agents 只给建议，执行与验证仍由你控制。',
    },
  ]}
/>
