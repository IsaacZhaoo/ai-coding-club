...
If you maintain a TypeScript client or server, use the [MCP 2026-07-28 migration guide](/docs/tutorials/mcp-2026-07-28-stateless-migration/) to separate the SDK v2 package upgrade from protocol adoption, state relocation, and legacy-client verification.

When the connection works but the Agent still chooses the wrong action or cannot recover from errors, use the [MCP Tool Design Guide](/docs/tutorials/mcp-tool-design-guide/) to review task boundaries, schemas, annotations, results, and error paths.
:::
...
- [Claude Code Skills, Hooks, and MCP](/docs/tutorials/claude-code-skills-hooks-mcp/) - Choose the right mechanism for procedures, event controls, and external connections
