...
<FAQSchema
  items={[
    {
      question: 'What is the difference between AI Agents and Cursor Rules?',
      answer: 'Cursor Rules define project-wide standards, while Agents define role-specific knowledge and workflows.',
    },
    {
      question: 'Can one project use multiple Agents?',
      answer: 'Yes. You can switch Agents based on task type, such as backend, frontend, or QA.',
    },
    {
      question: 'Will Agents run code automatically?',
      answer: 'No. Agents provide suggestions and guidance, but you control execution and verification.',
    },
  ]}
/>
