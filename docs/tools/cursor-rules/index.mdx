...
<FAQSchema
  items={[
    {
      question: 'Where should I place the Cursor Rules file?',
      answer: 'Place it at the repo root for global rules, or in subfolders for scoped rules.',
    },
    {
      question: 'How long should Rules be?',
      answer: 'Keep them concise. 300-500 lines is a reasonable upper bound for most projects.',
    },
    {
      question: 'How do I make AI follow the Rules strictly?',
      answer: 'Reference the Rules in prompts and enforce verification with lint/test commands.',
    },
  ]}
/>
