...
<SoftwareApplicationSchema
  name="ChatGPT"
  description="Conversational AI assistant by OpenAI for code generation, debugging, and programming explanations."
...
<SoftwareApplicationSchema
  name="DeepSeek"
  description="Open-source AI coding assistant with GPT-4 level quality and unlimited free usage."
  applicationCategory="DeveloperApplication"
  operatingSystem="Web"
  offers={{ price: "0", priceCurrency: "USD" }}
