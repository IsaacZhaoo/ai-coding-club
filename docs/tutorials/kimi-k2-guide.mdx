...
<HowToSchema
  name="Get started with Kimi K2"
  description="A quick workflow to set up and run a first Kimi K2 coding task."
  totalTime="PT10M"
  steps={[
    {
      name: 'Create a Kimi account',
      text: 'Register for Kimi and confirm access to K2.',
    },
    {
      name: 'Prepare context',
      text: 'Collect the files or documents you want to analyze.',
    },
    {
      name: 'Ask a focused prompt',
      text: 'Describe the goal and provide expected output format.',
    },
    {
      name: 'Validate results',
      text: 'Review changes and test or lint when code is generated.',
    },
  ]}
/>
...
Kimi K2 is the model and API layer. If you want Moonshot AI's current terminal coding agent—or need to migrate from the legacy Kimi CLI—use the [Kimi Code CLI guide](/docs/tutorials/kimi-code-cli-guide/).
