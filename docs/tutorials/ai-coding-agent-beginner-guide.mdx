...
### Weekend: Review Your Safety Loop

Review the diffs, commands, and repeated corrections from the week. Keep only the guidance that would prevent real mistakes next time.
