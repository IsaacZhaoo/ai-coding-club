...
If `Context` includes a long log, diff, or spec, check it with the [Token Counter](/docs/tutorials/token-counter-no-login/) before sending. The estimate helps you decide whether to trim noise, summarize evidence, or split the task.
...
- [Kimi Code CLI install and migration guide](/docs/tutorials/kimi-code-cli-guide/)
