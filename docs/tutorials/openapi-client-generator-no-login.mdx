...
If you only have YAML, convert it first. The tool may accept YAML-shaped files in the picker, but JSON is the safer path based on the current test.
...
That naming detail is a good reminder: generated code is not polished code. It is starter code.
