...
<FAQSchema
  items={[
    {
      question: 'How long does it take to finish the AI coding roadmap?',
      answer: 'Most learners finish in about 36 weeks with 2-5 hours per day, but you can move faster or slower.',
    },
    {
      question: 'Do I need prior coding experience?',
      answer: 'No. This roadmap starts from zero and is designed for complete beginners.',
    },
    {
      question: 'Which AI tools should I start with?',
      answer: 'Start with ChatGPT or Claude for guidance, then add an IDE tool like Cursor or Copilot when you need faster editing.',
    },
  ]}
/>
...
- This roadmap is a structured path for complete beginners who want to use AI as a tutor, reviewer, and coding partner.
- The target outcome is not "learn everything," but build enough skill to ship projects and qualify for junior-level work.
- Follow the phases in order, build along the way, and treat AI as a collaborator rather than an autopilot.

## Who This Is For

- Complete beginners with zero programming experience
- Career changers who need a practical, lower-cost route into software
- Self-taught learners who want a more structured progression
- Anyone willing to learn by building and validating real projects

## What You'll Get

- A 36-week learning path with clear phases and checkpoints
- A progression from basic concepts to projects, tools, and portfolio work
- A repeatable way to use AI for explanation, debugging, code review, and practice

## Freshness Note

> Structure reviewed on April 18, 2026. External tools, courses, prices, and linked resources may change over time, so verify time-sensitive details at the original source.

## Beginner Agent Guides

If you already know the basics and want to practice agentic coding safely, start with these companion tutorials:
...
Use the full 36-week roadmap if you are learning from zero. If you arrived from a Claude Code, Codex, or tool comparison article, pick the path that matches your next action:

| Goal | Start here | What you'll be able to do |
| --- | --- | --- |
| Learn coding from zero | [AI Coding Course](/docs/course/) | Finish Phase 1 and build your first small program |
| Try Claude Code safely | [Claude Code beginner guide](/docs/tutorials/claude-code-guide/) | Complete one small repo task with Git diff review and a verification command |
| Understand Codex / terminal agents | [Codex beginner guide](/docs/tutorials/codex-guide/) | Know when to use Codex, Claude Code, or an editor assistant |
| Build a repeatable agent workflow | [AI coding agent beginner route](/docs/tutorials/ai-coding-agent-beginner-guide/) | Move from chat prompts to scoped tasks, review, and project checkpoints |
...
## Stage 1: Foundations (Weeks 1-4) {#stage-1-reality-check}
...
## Stage 2: Building Projects (Weeks 5-12) {#stage-2-context}
...
- For structured API projects, learn how to [generate an OpenAPI client without login](/docs/tutorials/openapi-client-generator-no-login/) before adapting it with an AI coding assistant.
...
If you are moving from AI-assisted coding toward designing reliable Agent systems, use the [Coding Agent Engineering map](/docs/agent-engineering/) to connect prompts, context, memory, skills, harnesses, loops, and graphs.
...
- Client generation from an OpenAPI or Swagger spec
...
Most learners finish in about 36 weeks with consistent daily effort. If you can dedicate more time, you can compress the schedule.

### Do I need prior coding experience?

No. This roadmap starts from the basics and assumes zero prior coding knowledge.

### Which AI tool should I use first?

Start with ChatGPT or Claude for guidance and explanations. Add Cursor or Copilot later when you need faster editing across files.
...
- 💬 [Discussions](https://github.com/IsaacZhaoo/aiCodingClub/discussions) - Ask questions, share projects
- 📚 [Course Library](/docs/course) - 31 structured lessons from beginner to advanced
- 🛠️ [Tools & Resources](/docs/tools) - Curated AI coding tools and comparisons
- ❓ [FAQ](/docs/faq) - Quick answers to common AI coding questions

**Ready to start?** Begin with [Stage 0: Vibecoding](/docs/roadmap/stage0/) or dive into [Lesson 1: Your First AI Conversation](/docs/course/foundations/first-conversation).

**Built with AI, for AI learners** ✨

---

*Last updated: November 2025 | [Suggest improvements](https://github.com/IsaacZhaoo/aiCodingClub/issues) | Part of the AI Coding Club curriculum*
