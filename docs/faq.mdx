...
- New to AI coding? [Getting Started Tutorial](/docs/tutorials/getting-started)
...
**Next steps:**
- Read our [Getting Started Tutorial](/docs/tutorials/getting-started)
...
- [See our caching guide](/blog/claude-prompt-caching)
...
5. **How to get started?** → Try ChatGPT free, read our [tutorial](/docs/tutorials/getting-started)
